	...
	$('form').unbind('keypress');
		...
		$('#edit-submit').click(function() {
			$('input[type="text"]').each(function() {
				var val = $(this).val();
				if(val == Drupal.t("Enter role description")) { $(this).val(''); }
			});
		});
...
<a id="secondary_submit" href="javascript:void(0)" onclick="javascript:parent.$.colorbox.close(); return false;"><?php echo t('Cancel');?></a> <?php print $save; ?></td></tr>
</table>
