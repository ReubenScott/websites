...
if(!$('select[name=recent_activities]').val()) { return false; }
...
$('#content-part').attr('style','border:0');
		...
		<?php if($notice): ?><div align="center" class="notice"><?php print $notice; ?></div><?php endif;?>
		<div class="services">
			...
			<div class="services_dev">
				...
				<div>
					...
					<ul>
						<li><a href="<?php print $base_url;?>/covidien/device"><?php echo t('Service History'); ?></a></li>
						<li><a href="<?php print $base_url;?>/covidien/device"><?php echo t('HW/SW Configuration'); ?></a></li>
					</ul>
				</div>
			</div>
			</td>
			...
			<div class="services_rep">
				...
				<div>
					<p><a href="<?php echo $base_url.$report_url;?>"><?php echo t('Create, View and Print Data Summary Reports'); ?></a></p>
				</div>
			</div>
			</td>
			<td>
			<div class="services_adm">
				...
				<div>
					...
					<ul>
						<li><a href="<?php print $base_url;?>/covidien/admin/users/list"><?php echo t('Manage Users'); ?></a></li>
						<li><a href="<?php print $base_url;?><?php echo $catalog_page_url;?>"><?php echo t('View & Edit Hardware, Software and Document Catalogs'); ?></a></li>
						<li><a href="<?php print $base_url;?><?php echo $conf_page_url;?>"><?php echo t('Create and Manage Device Configurations'); ?></a></li>
					</ul>
				</div>
			</div>	
			</td>
			...
			<div class="services_fields">
				...
				<div class="form-item-div">
					<div class="form-item-left">
						<?php print_r(drupal_render($form));?>
					</div>
